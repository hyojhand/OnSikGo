INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (1, 'user@naver.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '김싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'USER', '김싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (2, 'store@naver.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '이싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'OWNER', '점주 이싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (3, 'store2@naver.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '박싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'OWNER', '점주 박싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (4, 'ssafy@naver.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '손싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'USER', '손싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (5, 'ssafy2@naver.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '정싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'USER', '정싸피');
