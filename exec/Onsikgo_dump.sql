INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (1, 'ssafy@ssafy.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '김싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'USER', '김싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (2, 'ssafystore@ssafy.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '점주 이싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'OWNER', '점주 이싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (3, 'ssafystore2@ssafy.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '점주 박싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'OWNER', '점주 박싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (4, 'ssafy2@ssafy.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '손싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'USER', '손싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (5, 'ssafy3@ssafy.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '정싸피', '$2a$10$zkucUGixA7DjuCblAx.wEugFDuRRz5u.SjCLNTKkqBMjy2kxHGyoC', 'USER', '정싸피');
INSERT INTO onsikgo.user (user_id, email, img_url, login_type, nickname, password, role, user_name) VALUES (6, 'admin@admin.com', 'https://onsikgo.s3.ap-northeast-2.amazonaws.com/user/pngwing.com.png', 'ONSIKGO', '관리자', '$2a$10$gtYiaI/1u9xTgezC1XUIVOi6DasTDoeUo1jbcnFhS2we2dz5PbgJq', 'ADMIN', '관리자');


INSERT INTO onsikgo.store (store_id, address, category, closing_time, extra_address, lat, lng, off_day, store_img_url, store_name, store_num, tel, user_id) VALUES (1, '부산 강서구 녹산산단335로 8', 'DESSERT', '22:00', '부산지방 중소기업청 1층', '35.0896696438317', '128.85538968215', '목요일,토요일', 'http://kkoma.net/web/product/big/201708/3673_shop1_597459.jpg', '따끈따끈 베이커리', '1234567891', '051-252-1234', 2);
...
INSERT INTO onsikgo.store (store_id, address, category, closing_time, extra_address, lat, lng, off_day, store_img_url, store_name, store_num, tel, user_id) VALUES (8, '부산 강서구 명지국제6로 107', 'INGREDIENT', '21:00', '대방디엠시티 1층', '35.092516', '128.911228', '목요일', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtTMi_hH9GYRI-bQPvpYX4FX-dt_Bv5zaKpA&usqp=CAU', '명지 과일가게', '1234567898', '051-126-3523', 3);
...
INSERT INTO onsikgo.store (store_id, address, category, closing_time, extra_address, lat, lng, off_day, store_img_url, store_name, store_num, tel, user_id) VALUES (12, '부산 강서구 녹산산단262로13번길 57', 'KOREA', '23:00', '녹산빌딩 1층', '35.088606', '128.852146', '일요일', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyvU5FFA3rHlydGPwrHyKBRyW9WkyltAzjCg&usqp=CAU', '한식 전문점', '3123456789', '051-654-6225', 3);
